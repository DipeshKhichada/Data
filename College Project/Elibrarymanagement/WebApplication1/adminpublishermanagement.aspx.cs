    ...
    public partial class adminpublishermanagement : System.Web.UI.Page
    {
        ...
        void addNewPublisher()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO publisher_master_tb(publisher_id,publisher_name) values(@publisher_id,@publisher_name)", con);
        ...
        public void updatePublisherByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update publisher_master_tb set publisher_name=@publisher_name WHERE publisher_id='" + TextBox1.Text.Trim() + "'", con);
                cmd.Parameters.AddWithValue("@publisher_name", TextBox2.Text.Trim());
